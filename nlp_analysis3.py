...
data=pd.read_csv("bing_file_10.csv")
'''
data2=pd.read_csv("bing_file2.csv")
data3=pd.read_csv("bing_file3.csv")
data4=pd.read_csv("bing_file4.csv")
data4_=pd.read_csv("bing_file5.csv")
data42=pd.read_csv("bing_file6.csv")
data43=pd.read_csv("bing_file7.csv")
data44=pd.read_csv("bing_file8.csv")
data12=pd.read_csv("bing_file_10.csv")
data5=data.append(data2)
data6=data5.append(data3)
data7=data6.append(data4)
data8=data7.append(data4_)
data9=data8.append(data42)
data10=data9.append(data43)
data11=data10.append(data44)
data13=data11.append(data12)
'''
data_final=data.drop_duplicates()
print(data_final)
data_final.to_csv("saved_final_data_3.csv")
all_data=[]
for elem in data_final.iterrows():
    all_data.append(elem[1].values)
...
kk=[]
#all_data["geo"]=all_data["title"].copy()
        ...
        if el[1]=="ORG":
            ...
            if nname not in names:
                if nname not in arr0:
                    arr0.append(nname)
                    kk.append([row[0],row[1],row[2],nname])
                if nname not in all:
                    all.append(nname)
    print(arr0)
pd.DataFrame(kk).to_csv("geocoded_data_3.csv")        
